...
(function(){
const pages=[['index.html','Home'],['transfers.html','Transfers'],['news.html','News'],['videos.html','Videos'],['players.html','Players'],['clubs.html','Clubs'],['movies.html','Movies'],['awards.html','Awards'],['settings.html','Settings'],['contact-support.html','Support']];
function mount(){
  ...
  host.innerHTML='<div class="site-nav-inner"><a class="site-brand" href="index.html"><b>FABRIZIO</b> ROMANO</a><button class="site-menu" aria-label="Open menu" aria-expanded="false">☰</button><nav>'+pages.map(p=>'<a href="'+p[0]+'" class="'+(current===p[0]?'active':'')+'">'+p[1]+'</a>').join('')+'</nav></div><div class="movie-subnav"><strong>🎬 Movie Centre</strong><a href="movies.html">Discover</a><a href="movies.html#trendingSection">Trending</a><a href="movies.html#catalogue">Latest</a><a href="movies.html#catalogue">Upcoming</a><a href="movies.html#catalogue">Genres</a><a href="awards.html" class="'+(current==='awards.html'?'active':'')+'">Awards</a><a href="artist-detail.html">Artists</a></div>';
